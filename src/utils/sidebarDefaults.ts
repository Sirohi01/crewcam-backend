...
export const DEFAULT_SIDEBAR_ITEMS: SidebarDefaultItem[] = [
  ...
  { section: 'Hiring Process', label: 'Interview List', href: '/dashboard/hiring/interviews/list', icon: 'UserPlus', order: 5, requiredPermission: 'ATS_READ', categories: HR_AND_HOD },
